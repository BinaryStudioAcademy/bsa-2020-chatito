...
export class createEntities1596715094021 implements MigrationInterface {
    name = 'createEntities1596715094021'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "workspace" DROP COLUMN "createdByUserId"`);
        await queryRunner.query(`ALTER TABLE "workspace" ADD "imageUrl" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "workspace" ADD "createdByUserIdId" uuid`);
        await queryRunner.query(`ALTER TABLE "workspace" DROP CONSTRAINT "UQ_406f56fc2a42ad5f541973cdbee"`);
        await queryRunner.query(`ALTER TABLE "workspace" DROP COLUMN "name"`);
        await queryRunner.query(`ALTER TABLE "workspace" ADD "name" character varying(150) NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "workspace" DROP COLUMN "name"`);
        await queryRunner.query(`ALTER TABLE "workspace" ADD "name" character varying(100) NOT NULL`);
        await queryRunner.query(`ALTER TABLE "workspace" ADD CONSTRAINT "UQ_406f56fc2a42ad5f541973cdbee" UNIQUE ("name")`);
        await queryRunner.query(`ALTER TABLE "workspace" DROP COLUMN "createdByUserIdId"`);
        await queryRunner.query(`ALTER TABLE "workspace" DROP COLUMN "imageUrl"`);
        await queryRunner.query(`ALTER TABLE "workspace" ADD "createdByUserId" uuid NOT NULL`);
